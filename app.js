 ...
 * Quita la extensión original y le pone un punto antes de las últimas 2 letras
...
const generateDomainHack = (domainList) =>
  domainList.map(domain => {
    // Quita la extensión original
    const punto = domain.lastIndexOf('.');
    const name = domain.slice(0, punto); // dominio sin extensión

    //Pone el puto antes de las últimas 2 letras
